Pod::Spec.new do |s|
  ...
  # cross-platform C++ core ScumbleRenderer (shared/skity) — the same Draw entry
  ...
  s.source_files = 'ios/Classes/**/*.{h,m,mm}', 'shared/skity/ScumbleRenderer.{h,cc}',
  ...
  s.public_header_files = 'ios/Classes/**/*.h', 'shared/skity/ScumbleRenderer.h',
