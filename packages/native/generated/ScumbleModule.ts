...
const ADDON_NAME = "ScumbleModule";
...
export interface ScumbleModuleSpec {
...
export function requireScumbleModule(): ScumbleModuleSpec {
  ...
  if (lynxNodeAPI?.requireNodeAddon) {
    ...
    if (addon) {
      return addon as unknown as ScumbleModuleSpec;
    }
  }
  ...
  if (loader?.load !== undefined) {
    ...
    if (addon !== undefined) {
      return addon as ScumbleModuleSpec;
    }
  }
...
export const ScumbleModule = new Proxy({}, {
  get(_target, property) {
    return requireScumbleModule()[property as keyof ScumbleModuleSpec];
  },
}) as ScumbleModuleSpec;
...
export function installScumbleModuleShim(): void {
...
installScumbleModuleShim();

export default ScumbleModule;
