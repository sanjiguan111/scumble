...
import { parseFit, parseImageFilterMode, parseImageMipmapMode } from "@scumble/graphics";
...
/** What `<scumble-image>` consumes after normalization. */
...
/**
 * Normalize {@link ImageProps} into the flat numeric/uri props `<scumble-image>`
