...
/**
 * @scumble/graphics — framework-agnostic value parsers for scumble.
 *
 ...
 *
 * Framework-agnostic: shared by `@scumble/react` (and a future Vue layer).
 ...
 *
 * @example
 * import { parseColor, parsePath, Path2D } from "@scumble/graphics";
 *
